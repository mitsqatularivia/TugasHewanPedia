...
import simple.example.hewanpedia.model.Gajah;
...
public class DataProvider {
    ...
    private static List<Gajah> initDataGajah(Context ctx) {
        ...
        gajahs.add(new Gajah("Gajah india", "India",
                "Gajah india adalah salah satu subspesies gajah asia.", R.drawable.india));
        gajahs.add(new Gajah("Gajah semak afrika", "afrika ",
                "Gajah semak afrika atau gajah sabana afrika adalah yang terbesar dari dua spesies gajah afrika.", R.drawable.semak_afrika));
        gajahs.add(new Gajah("Gajah kalimantan", "Indonesia",
                "Gajah kalimantan adalah subspesies dari gajah asia dan dapat ditemukan di Kalimantan Utara dan Sabah. ", R.drawable.kalimantan));
        gajahs.add(new Gajah("Gajah srilangka", "Sri Lanka",
                "Gajah sri lanka adalah salah satu dari tiga subspesies gajah asia. Subspesies ini hidup di pulau Sri Lanka.", R.drawable.sri));
        gajahs.add(new Gajah("Gajah bergading lurus", "asia",
                "Palaeoloxodon antiquus adalah spesies gajah yang telah punah.", R.drawable.lurus));
        gajahs.add(new Gajah("Gajah hutan Afrika", "Jepang",
                "Gajah hutan afrika adalah spesies gajah yang tinggal di hutan di Cekungan Kongo.", R.drawable.hu));
        return gajahs;
    }
